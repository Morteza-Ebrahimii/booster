...
const badPractice = `£${(2 + 10) * 2}`;

// Why can this code be seen as bad practice? Comment your answer.
let badCode = badPractice;
//!because it`s hard code and The probability of error in calculation in this way is very high

/* BETTER PRACTICE */
const ten = 10;

const resAdd = add(startingValue, ten);
const resMultiply = multiply(resAdd);
const resFormat = format(resMultiply);

let goodCode = resFormat;
